...
var templateObject_1$s, templateObject_2$f, templateObject_3$9;
...
var templateObject_1$o, templateObject_2$d, templateObject_3$8, templateObject_4$6, templateObject_5$4, templateObject_6$1, templateObject_7$1;
...
var templateObject_1$n, templateObject_2$c, templateObject_3$7, templateObject_4$5, templateObject_5$3;
...
var RotatingPancakeIcon = styled(Icon$u)(templateObject_4$4 || (templateObject_4$4 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
var FloatingPanIcon = styled(Icon$v)(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var templateObject_1$m, templateObject_2$b, templateObject_3$6, templateObject_4$4, templateObject_5$2;
...
var templateObject_1$k, templateObject_2$a, templateObject_3$5, templateObject_4$3, templateObject_5$1, templateObject_6, templateObject_7;
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#9A6AFF", background: "#08060B", backgroundDisabled: "#3c3742", backgroundAlt: "#08090A", cardBorder: "#383241", contrast: "#FFFFFF", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#191326", input: "#372F47", inputSecondary: "#262130", primaryDark: "#0098A1", tertiary: "#353547", text: "#F4EEFF", textDisabled: "#666171", textSubtle: "#0AABFF", disabled: "#524B63", gradients: {
...
var templateObject_1$e, templateObject_2$6, templateObject_3$3, templateObject_4$2;
...
var Logo$3 = function (_a) {
    ...
    var textColor = isDark ? "red" : "#000000";
    return (React.createElement(Svg, __assign({ fill: textColor, xmlns: "http://www.w3.org/2000/svg", width: "159.536", height: "96.203", viewBox: "0 0 159.536 96.203" }, props),
        React.createElement("g", { id: "Group_1099", "data-name": "Group 1099", transform: "translate(-30.648 -27.797)" },
            React.createElement("g", { id: "Group_1095", "data-name": "Group 1095", transform: "translate(-121.352 40.315)" },
                React.createElement("path", { id: "Path_9563", "data-name": "Path 9563", d: "M853.887-149.584v-23.09a3.769,3.769,0,0,0,2.907-3.667,3.771,3.771,0,0,0-3.771-3.771,3.756,3.756,0,0,0-2.7,1.139L829.847-190.8a3.775,3.775,0,0,0,.077-.76,3.771,3.771,0,0,0-3.771-3.771,3.771,3.771,0,0,0-3.771,3.771,3.794,3.794,0,0,0,.077.76l-20.444,11.8a3.759,3.759,0,0,0-2.681-1.12,3.771,3.771,0,0,0-3.771,3.771,3.769,3.769,0,0,0,2.855,3.654v23.117a3.769,3.769,0,0,0-2.855,3.654,3.771,3.771,0,0,0,3.771,3.771,3.754,3.754,0,0,0,2.377-.845l20.749,11.979a3.794,3.794,0,0,0-.077.76,3.771,3.771,0,0,0,3.771,3.771,3.771,3.771,0,0,0,3.771-3.771,3.778,3.778,0,0,0-.077-.76l20.777-12a3.753,3.753,0,0,0,2.4.861,3.771,3.771,0,0,0,3.771-3.771A3.769,3.769,0,0,0,853.887-149.584ZM850-148.163l-8.112-4.683v-16.117l8.364-4.829a3.764,3.764,0,0,0,1.857,1.1v23.117A3.767,3.767,0,0,0,850-148.163Zm-.582-29.281a3.772,3.772,0,0,0-.165,1.1,3.767,3.767,0,0,0,.138,1L841-170.5l-13.957-8.058V-187.9a3.766,3.766,0,0,0,2.04-1.289Zm-37.22,24.6v-16.115l13.957-8.058,13.956,8.058v16.115l-13.956,8.058Zm11.027-36.337a3.768,3.768,0,0,0,2.04,1.288v9.336L811.308-170.5l-8.347-4.819a3.759,3.759,0,0,0,.144-1.021,3.768,3.768,0,0,0-.172-1.127Zm-23.027,39.6v-23.09a3.76,3.76,0,0,0,1.89-1.1l8.331,4.809v16.117l-8.076,4.662A3.765,3.765,0,0,0,800.2-149.585Zm2.6,5.165a3.753,3.753,0,0,0,.311-1.5,3.79,3.79,0,0,0-.055-.621l8.258-4.768,13.957,8.057v9.336a3.768,3.768,0,0,0-2.04,1.288Zm24.249,10.507v-9.336L841-151.307l8.3,4.8a3.769,3.769,0,0,0-.052.594,3.758,3.758,0,0,0,.3,1.475l-20.47,11.818A3.77,3.77,0,0,0,827.043-133.913Z", transform: "translate(-594.192 182.809)" }),
                React.createElement("g", { id: "Group_1094", "data-name": "Group 1094", transform: "translate(152 66.53)" },
                    React.createElement("path", { id: "Path_9561", "data-name": "Path 9561", d: "M1499.071-123.348a3.28,3.28,0,0,1-.378-.02c-.116-.014-.242-.035-.375-.063L1498-123.5l-.648,2.222-2.7,8.821c-.175.531-.323.975-.439,1.317-.1.245-.188.491-.278.736l-4.33-13.09-.3.06-.3.056a1.65,1.65,0,0,1-.286.029,2.381,2.381,0,0,1-.565-.081l-.326-.082-.093.323c-.143.5-.514,1.64-1.1,3.4-.371,1.136-.95,2.842-1.721,5.071-.554,1.612-1.053,3.049-1.485,4.283l-1.751-5.508-1.357-4.767-.774-2.752-1.355.114c-.2,0-.376-.007-.531-.022s-.338-.037-.518-.065l-.564-.09,4.385,13.438,1.008,3.37h.26a1.179,1.179,0,0,0,.351-.075,4.171,4.171,0,0,1,.436-.016,2.341,2.341,0,0,1,.328.02c.1.014.218.036.353.064l.3.063,4.383-12.706,4.117,12.7.3-.06a3.821,3.821,0,0,1,.686-.085,2.821,2.821,0,0,1,.361.02c.105.013.223.034.351.063l.305.068,4.533-13.321c.087-.207.233-.589.444-1.162.338-.88.582-1.489.723-1.809l.246-.556Z", transform: "translate(-1371.61 123.651)" }),
                    React.createElement("path", { id: "Path_9562", "data-name": "Path 9562", d: "M1675.209-121.187c-.925-.6-2.506-.893-4.832-.893h-4.26v16.526l.13-.038q.157-.023.45-.056a5,5,0,0,1,1.04-.011c.148.014.313.036.492.066l.271.045v-7.41l.5.034c.426.031.779.046,1.049.046.021,0,.057,0,.525-.047.305-.031.591-.061.878-.095a8.183,8.183,0,0,0,3.9-1.658,4.29,4.29,0,0,0,1.28-3.337A3.506,3.506,0,0,0,1675.209-121.187Zm-1.186,3.309a3.391,3.391,0,0,1-.922,2.44,3.924,3.924,0,0,1-2.55,1.115l-1.247.046-.8-.036v-6.372l1.586-.04,1.523.045a2.521,2.521,0,0,1,1.849.917A2.956,2.956,0,0,1,1674.023-117.878Z", transform: "translate(-1517.097 122.542)" }),
                    React.createElement("g", { id: "Group_1087", "data-name": "Group 1087", transform: "translate(0 0.273)" },
                        React.createElement("path", { id: "Path_9564", "data-name": "Path 9564", d: "M1041.947-122.8a.565.565,0,0,0-.331-.091h-1.707a.521.521,0,0,0-.323.1c-.07.052-.095.093-.095.112v6.982h-12.019v-6.982c0-.017,0-.058-.086-.118a.564.564,0,0,0-.331-.091h-1.707a.524.524,0,0,0-.324.1c-.069.052-.094.093-.094.112v16.306c0,.017,0,.058.086.118a.566.566,0,0,0,.331.091h1.707a.588.588,0,0,0,.335-.088c.082-.054.082-.1.082-.121v-7.956h12.019v7.956c0,.017,0,.058.087.118a.565.565,0,0,0,.331.091h1.707a.588.588,0,0,0,.335-.088c.083-.054.083-.1.083-.121v-16.306C1042.034-122.7,1042.034-122.743,1041.947-122.8Z", transform: "translate(-1024.93 122.893)" })),
                    React.createElement("g", { id: "Group_1088", "data-name": "Group 1088", transform: "translate(20.99 0.114)" },
                        React.createElement("path", { id: "Path_9565", "data-name": "Path 9565", d: "M1132.282-119.723a5.755,5.755,0,0,0-1.8-2.175,8.014,8.014,0,0,0-2.777-1.267,14.725,14.725,0,0,0-3.606-.411,14.825,14.825,0,0,0-3.6.406,8.049,8.049,0,0,0-2.785,1.267,5.781,5.781,0,0,0-1.824,2.2,7.233,7.233,0,0,0-.648,3.156v2.989a7.316,7.316,0,0,0,.64,3.152,5.658,5.658,0,0,0,1.815,2.2,8.165,8.165,0,0,0,2.81,1.267,14.768,14.768,0,0,0,3.591.412,14.844,14.844,0,0,0,3.607-.412,7.988,7.988,0,0,0,2.792-1.266,5.673,5.673,0,0,0,1.791-2.179,7.374,7.374,0,0,0,.632-3.169v-2.989A7.287,7.287,0,0,0,1132.282-119.723Zm-1.936,6.162a5.409,5.409,0,0,1-1.583,4.224,6.813,6.813,0,0,1-4.664,1.41,8.849,8.849,0,0,1-3.331-.562,4.431,4.431,0,0,1-2.175-1.855,6.208,6.208,0,0,1-.759-3.217v-2.989a5.4,5.4,0,0,1,1.588-4.224,6.843,6.843,0,0,1,4.677-1.41,9.843,9.843,0,0,1,2.613.315,5.242,5.242,0,0,1,1.949.978,4.338,4.338,0,0,1,1.249,1.779,6.953,6.953,0,0,1,.436,2.563Z", transform: "translate(-1115.243 123.576)" })),
                    React.createElement("g", { id: "Group_1089", "data-name": "Group 1089", transform: "translate(42.806 0.114)" },
                        React.createElement("path", { id: "Path_9566", "data-name": "Path 9566", d: "M1225.646-106.77l-.009-.01-6.4-7.392.439-.081a8.044,8.044,0,0,0,3.717-1.576,3.505,3.505,0,0,0,1.344-2.849v-.17a3.5,3.5,0,0,0-1.125-2.712,6.869,6.869,0,0,0-3.191-1.541,21.957,21.957,0,0,0-4.835-.475c-.434,0-1.038.006-1.793.017s-1.537.034-2.324.068-1.386.066-1.79.1c-.26.018-.568.077-.568.255V-106.9a.147.147,0,0,0,.071.13.45.45,0,0,0,.281.079h1.805a.455.455,0,0,0,.285-.075.153.153,0,0,0,.067-.134v-7.079l.262.007c1.785.045,3.031.068,3.7.068h.986l6.077,6.986a.792.792,0,0,0,.264.189,1.566,1.566,0,0,0,.438.038h2.151a.347.347,0,0,0,.169-.027.117.117,0,0,0,0-.016A.145.145,0,0,0,1225.646-106.77Zm-10.06-8.437c-.506,0-1.755-.015-3.714-.046l-.251,0V-122.1l.234-.02c.548-.046,1.769-.069,3.731-.069a18.214,18.214,0,0,1,3.632.3,4.475,4.475,0,0,1,2.226,1.046,2.662,2.662,0,0,1,.783,1.99v.17a2.834,2.834,0,0,1-.8,2.113,4.422,4.422,0,0,1-2.236,1.064A18.3,18.3,0,0,1,1215.586-115.208Z", transform: "translate(-1209.111 123.576)" })),
                    React.createElement("g", { id: "Group_1090", "data-name": "Group 1090", transform: "translate(62.864 0.114)" },
                        React.createElement("path", { id: "Path_9567", "data-name": "Path 9567", d: "M1314.24-106.845h0l-.011-.028-6.222-15.117a2.184,2.184,0,0,0-.734-.937,3.063,3.063,0,0,0-1.107-.5,5.83,5.83,0,0,0-1.321-.146,5.172,5.172,0,0,0-1.972.372,2.169,2.169,0,0,0-1.224,1.238l-6.234,15.122h0c0,.007,0,.018,0,.032s.027.034.052.049a.49.49,0,0,0,.267.069h1.987a.555.555,0,0,0,.244-.073.244.244,0,0,0,.121-.1l.006-.014,2.215-5.493h9.045l2.255,5.51c.02.061.057.175.332.175h1.987a.561.561,0,0,0,.292-.052c.014-.01.027-.018.027-.066C1314.241-106.827,1314.241-106.837,1314.24-106.845Zm-13.5-6.857,3.194-7.971a.894.894,0,0,1,.91-.579.886.886,0,0,1,.878.581l3.193,7.969Z", transform: "translate(-1295.414 123.576)" })),
                    React.createElement("g", { id: "Group_1091", "data-name": "Group 1091", transform: "translate(127.217 0.111)" },
                        React.createElement("path", { id: "Path_9568", "data-name": "Path 9568", d: "M1591.131-106.856h0l-.012-.028L1584.9-122a2.186,2.186,0,0,0-.734-.937,3.06,3.06,0,0,0-1.107-.5,5.831,5.831,0,0,0-1.321-.146,5.165,5.165,0,0,0-1.971.372,2.17,2.17,0,0,0-1.224,1.238l-6.233,15.122h0c0,.007,0,.018,0,.032s.027.034.052.049a.489.489,0,0,0,.267.069h1.987a.554.554,0,0,0,.243-.073.243.243,0,0,0,.121-.1l.006-.014,2.215-5.494h9.045l2.254,5.51c.02.061.057.175.332.175h1.987a.561.561,0,0,0,.291-.052c.014-.01.027-.018.027-.066A.321.321,0,0,0,1591.131-106.856Zm-13.5-6.857,3.194-7.971a.894.894,0,0,1,.91-.579.886.886,0,0,1,.878.581l3.193,7.969Z", transform: "translate(-1572.305 123.587)" })),
                    React.createElement("g", { id: "Group_1093", "data-name": "Group 1093", transform: "translate(89.692 0)" },
                        React.createElement("g", { id: "Group_1092", "data-name": "Group 1092", transform: "translate(0 0)" },
                            React.createElement("path", { id: "Path_9569", "data-name": "Path 9569", d: "M1411.435-110.6h.32a7.327,7.327,0,0,0,2.175,1.807,6.7,6.7,0,0,0,3.135.676,5.186,5.186,0,0,0,3.295-1.014,3.042,3.042,0,0,0,1.3-2.471q0-1.841-2.655-2.821-2.495-.792-4.942-1.6-2.688-1.2-2.687-3.462a3.823,3.823,0,0,1,2.16-3.462,10.253,10.253,0,0,1,5.1-1.119,11.718,11.718,0,0,1,2.559.285,6.572,6.572,0,0,1,2.159.857q-.192.338-.472.921a10.456,10.456,0,0,0-.439,1.038h-.32a3.528,3.528,0,0,0-1.56-1.538,5.3,5.3,0,0,0-2.5-.56,5.232,5.232,0,0,0-2.919.787,2.343,2.343,0,0,0-1.207,2.022q0,1.818,2.671,2.821,2.495.816,4.99,1.6,2.687,1.142,2.687,3.275a4.611,4.611,0,0,1-2.4,4.033,10.363,10.363,0,0,1-5.726,1.457,12.363,12.363,0,0,1-2.919-.384,6.066,6.066,0,0,1-2.391-1.049,4.673,4.673,0,0,0,.328-.909Q1411.307-109.94,1411.435-110.6Z", transform: "translate(-1410.844 124.066)" }))))))));
};
...
var Icon$b = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("g", { id: "Group_393", "data-name": "Group 393", transform: "translate(-21 -200)" },
            React.createElement("g", { id: "Group_392", "data-name": "Group 392", transform: "translate(-6.731 -38.731)" },
                React.createElement("g", { id: "Ellipse_12", "data-name": "Ellipse 12", transform: "translate(27.731 238.731)", fill: "none", stroke: "#0aabff", "stroke-width": "2" },
                    React.createElement("circle", { cx: "14", cy: "14", r: "14", stroke: "none" }),
                    React.createElement("circle", { cx: "14", cy: "14", r: "13", fill: "none" }))),
            React.createElement("g", { id: "Group_391", "data-name": "Group 391", transform: "translate(84.662 1299.068)" },
                React.createElement("path", { id: "Path_546", "data-name": "Path 546", d: "M-57.862-1080.975c.8-.212,5.245-5.6,5.245-5.6l4.1,4.438,6.727-6.763", transform: "translate(0 -0.028)", fill: "none", stroke: "#0aabff", "stroke-linecap": "round", "stroke-width": "2" }),
                React.createElement("path", { id: "Path_547", "data-name": "Path 547", d: "M-45.473-1089.133h5.1v5.174", transform: "translate(-1.084 0)", fill: "none", stroke: "#0aabff", "stroke-linecap": "round", "stroke-width": "2" })))));
};

var Icon$a = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("g", { id: "Group_390", "data-name": "Group 390", transform: "translate(-28.731 -259.731)" },
            React.createElement("g", { id: "Ellipse_12", "data-name": "Ellipse 12", transform: "translate(28.731 259.731)", fill: "none", stroke: "#0aabff", "stroke-width": "2" },
                React.createElement("circle", { cx: "14", cy: "14", r: "14", stroke: "none" }),
                React.createElement("circle", { cx: "14", cy: "14", r: "13", fill: "none" })),
            React.createElement("g", { id: "Ellipse_13", "data-name": "Ellipse 13", transform: "translate(35.731 266.731)", fill: "none", stroke: "#0aabff", "stroke-width": "2" },
                React.createElement("circle", { cx: "7", cy: "7", r: "7", stroke: "none" }),
                React.createElement("circle", { cx: "7", cy: "7", r: "6", fill: "none" }))),
        " "));
};

var Icon$9 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("g", { id: "Group_394", "data-name": "Group 394", transform: "translate(316.75 -339.014)" },
            React.createElement("path", { id: "Path_548", "data-name": "Path 548", d: "M-304.168,340.949A13.16,13.16,0,0,0-315.75,354.01a13.16,13.16,0,0,0,13.158,13.158,13.16,13.16,0,0,0,13.082-11.732", transform: "translate(0 -0.841)", fill: "none", stroke: "#0aabff", "stroke-miterlimit": "10", "stroke-width": "2" }),
            React.createElement("path", { id: "Path_549", "data-name": "Path 549", d: "M-278.02,340.679a13.157,13.157,0,0,1,13.158,13.155", transform: "translate(-24.572 -0.665)", fill: "none", stroke: "#0aabff", "stroke-miterlimit": "10", "stroke-width": "2" }),
            React.createElement("path", { id: "Path_550", "data-name": "Path 550", d: "M-278.02,339.658v14.114H-263.9", transform: "translate(-24.571 -0.604)", fill: "none", stroke: "#0aabff", "stroke-miterlimit": "10", "stroke-width": "2" }))));
};

var Icon$8 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("g", { id: "Group_398", "data-name": "Group 398", transform: "translate(60 -338)" },
            React.createElement("g", { id: "Group_396", "data-name": "Group 396", transform: "translate(-11.946 23.655)" },
                React.createElement("g", { id: "Group_395", "data-name": "Group 395", transform: "translate(-43.073 322.403)" },
                    React.createElement("path", { id: "Path_551", "data-name": "Path 551", d: "M-8.327,500.544a10.245,10.245,0,0,1-3.549-.586c-.071-.028-.142-.055-.211-.086a1.908,1.908,0,0,1-1.366-2.454,4.824,4.824,0,0,1,1.322-2.638c.252-.263.5-.29.713-.1s.2.455-.047.716a4.175,4.175,0,0,0-1.12,2.376.9.9,0,0,0,.556,1.115,5.818,5.818,0,0,0,2.145.63,8.959,8.959,0,0,0,4.494-.438c1-.4,1.123-.68.9-1.722A4.266,4.266,0,0,0-5.532,495.4a.737.737,0,0,1-.192-.481.465.465,0,0,1,.3-.333.632.632,0,0,1,.487.141,4.752,4.752,0,0,1,1.4,2.735c.023.139.036.28.054.42a1.6,1.6,0,0,1-.78,1.637,5.953,5.953,0,0,1-2.5.876C-7.347,500.477-7.935,500.507-8.327,500.544Z", transform: "translate(13.511 -488.659)", fill: "#0aabff", stroke: "#0aabff", "stroke-width": "0.5" }),
                    React.createElement("path", { id: "Path_552", "data-name": "Path 552", d: "M17.5,410.48a3.2,3.2,0,1,1,3.194-3.2A3.2,3.2,0,0,1,17.5,410.48Zm-2.282-3.192a2.281,2.281,0,1,0,2.275-2.283A2.285,2.285,0,0,0,15.222,407.289Z", transform: "translate(-12.492 -404.089)", fill: "#0aabff", stroke: "#0aabff", "stroke-width": "0.5" })),
                React.createElement("line", { id: "Line_2", "data-name": "Line 2", x2: "5.595", transform: "translate(-30.631 324.718)", fill: "none", stroke: "#0aabff", "stroke-linecap": "round", "stroke-width": "1.5" }),
                React.createElement("line", { id: "Line_3", "data-name": "Line 3", x2: "5.595", transform: "translate(-30.631 328.345)", fill: "none", stroke: "#0aabff", "stroke-linecap": "round", "stroke-width": "1.5" }),
                React.createElement("line", { id: "Line_4", "data-name": "Line 4", x2: "5.595", transform: "translate(-30.631 331.752)", fill: "none", stroke: "#0aabff", "stroke-linecap": "round", "stroke-width": "1.5" })),
            React.createElement("g", { id: "Group_397", "data-name": "Group 397", transform: "translate(-88.731 78.269)" },
                React.createElement("g", { id: "Ellipse_12", "data-name": "Ellipse 12", transform: "translate(28.731 259.731)", fill: "none", stroke: "#0aabff", "stroke-width": "2" },
                    React.createElement("circle", { cx: "14", cy: "14", r: "14", stroke: "none" }),
                    React.createElement("circle", { cx: "14", cy: "14", r: "13", fill: "none" }))))));
};
...
var ButtonCollapse = React.memo(Logo$2, function (prev, next) { return prev.isPushed === next.isPushed; });
...
var Logo = function (_a) {
    var isMobile = _a.isMobile, isDark = _a.isDark, href = _a.href, isPushed = _a.isPushed;
    var isAbsoluteUrl = href.startsWith("http");
    var innerLogo = (React.createElement(React.Fragment, null,
        isPushed && !isMobile ? (
        // <LogoIcon className="mobile-icon" />
        React.createElement(LogoWithText, { className: "desktop-icon", isDark: isDark })) : (""),
        isMobile && (React.createElement(LogoWithText, { isDark: isDark }))));
    return (React.createElement(Flex, { style: {
            ...
            marginBottom: '25px',
        } }, isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "Home page" }, innerLogo)) : (React.createElement(StyledLink, { to: href, "aria-label": "Home page" }, innerLogo))));
};
...
var PanelBody = function (_a) {
    ...
    return (React.createElement(Container$1, null,
        React.createElement(Logo$1, { isMobile: isMobile, isPushed: isPushed, isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" }),
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container, null,
        React.createElement(MenuEntry, { isActive: false },
            React.createElement(MenuLink, { href: "https://horaswap.com" },
                React.createElement(LinkLabelMemo, { isPushed: isPushed }, "horaswap.com"))),
        React.createElement(MenuEntry, { isActive: false },
            React.createElement(MenuLink, { href: "#" },
                React.createElement(LinkLabelMemo, { isPushed: isPushed }, "Docs"))),
        React.createElement(MenuEntry, { isActive: false },
            React.createElement(MenuLink, { href: "https://twitter.com/os_hora", target: "_blank" },
                React.createElement(LinkLabelMemo, { isPushed: isPushed }, "Twitter")))));
};
...
var Menu = function (_a) {
    ...
    return (React.createElement(Wrapper, null,
        React.createElement(BodyWrapper, null,
            React.createElement(ButtonCollapse, { isPushed: isPushed, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" }),
